...
include $level.'template/admin/excel_export.php';
	...
	"SELECT enroll_id,
	 ...
	 ORDER BY enroll_total_correct desc,enroll_total_time ,enroll_dt   ",0
	);
	$actions=array(
	...
	if($_POST["type"]=="export")
	{
		...
		$filename="hp_partner_enroll_total";
...
<form action="list_partner_enroll.php" id="export" method="post">
