...
<script type="text/javascript">
    $.fn.ready(function(){
		if($.url().param("category_type"))
		{
			...
			$("#category_type").attr('disabled', 'disabled');
			//$("#category_type").attr('disabled', 'disabled');
		}
		$.ajax({
			data:{category_id:$.url().param("id")},
			type:"POST",
			dataType:"json",
			url:"../../htinmotion/orm/category/core.php?type=get_category_by_category_id",
		...
		$("#edit").click(function(){
			$.ajax({
				type:"POST",
				data:$('form#edit_category').serializeArray(),
				dataType:"xml",
				url:"../../htinmotion/orm/category/core.php?type=edit_category",
        ...
        <ul>
		    ...
		    <li class="complex" >
	            ...
	            <div>
	                    ...
	                    <input  type="text" class="field text large"  name="category_name"  id="category_name"/>
		     ...
		     <li>
		        <div>
		              <span class="right">
		                <a id="edit"  class="btn i_arrow_right icon blue" >Sửa thể loại</a>
		            </span>
		        </div>
		     </li>
