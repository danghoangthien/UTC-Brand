...
(function($) {
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			var elemWidth = ($(this).attr('width'))?parseInt($(this).attr('width')):parseInt($(this).width());
			var elemHeight = ($(this).attr('height'))?parseInt($(this).attr('height')):parseInt($(this).height());
			...
			panoramaViewport.bind('mouseout', function() {
				$(panoramaContainer).stop();
				panorama_animate(panoramaContainer, elemWidth, settings);
			});
